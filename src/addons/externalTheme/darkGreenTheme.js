...
export const darkGreenThemeTemplate = `
<!--template XML-->
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <style eblock-predefined="" d-tag="dark-green-theme">
        ${darkShare}

        .season-topic-drag-group {
            --dark-green-topic-base-fill-color: #60A917;
        }

        [season-topic-global] {
            --dark-green-topic-base-fill-color: #60A917;
            --topic-base-fill-color: var(--dark-green-topic-base-fill-color) !important;
    ...
    <desc eblock-predefined="" season-topic-parameters="dark-green-theme">
    {
