...
export const darkBlueThemeTemplate = `
<!--template XML-->
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <style eblock-predefined="" d-tag="dark-blue-theme">
        ${darkShare}

        .season-topic-drag-group {
            --dark-blue-topic-base-fill-color: #1BA1E2;
        }

        [season-topic-global] {
            --dark-blue-topic-base-fill-color: #1BA1E2;
            --topic-base-fill-color: var(--dark-blue-topic-base-fill-color) !important;
    ...
    <desc eblock-predefined="" season-topic-parameters="dark-blue-theme">
    {
